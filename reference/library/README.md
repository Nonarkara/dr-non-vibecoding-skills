# The Library — books that shape how we ship for humans

The complete index of book-derived skills in this repo. Every entry links to a local `SKILL.md` (the consolidated essence with glossary, patterns, and cheatsheet) and to the live skillhub (the full multi-chapter skill).

This file is the **table of contents**. The router that picks the right book for a given problem is [`skills/library-of-human-wisdom/SKILL.md`](../../skills/library-of-human-wisdom/SKILL.md). Load *that* skill first; this file is for orientation and browsing.
...
| Column | Meaning |
|---|---|
| **Local slug** | The local skill folder name. Path is `skills/<slug>/SKILL.md`. The 35+ book-derived skills carry their live skillhub IDs as suffixes (`<title>-<id>`). |
| **Book** | Author and title — the source the skill distills. |
| **Essence** | One sentence. The thing you take away. |
| **Cluster** | Design · Decision · Writing · People · Business · Finance · Practice |
| **Live** | Link to the full multi-chapter skill on the nonscrape skillhub. |

---

## The 35+ books (mirrored from the live skillhub)

### Design & craft

| Local slug | Book | Essence |
|---|---|---|
| `everyday-design-fundamentals-14by7eo` | Norman — *The Design of Everyday Things* | Affordances, signifiers, mapping, feedback — the seven stages of every action a user performs. |
| `emotional-design-three-levels-for-meaningful-products-17bhy7j` | Norman — *Emotional Design* | Three levels — visceral, behavioral, reflective — that decide whether a product is used once or for years. |
| `pattern-language-design-toolkit-1pms7oa` | Alexander — *A Pattern Language* | Towns, buildings, and software are made of patterns; the patterns live in the world, not in your head. |
| `simplicity-moves-ten-laws-for-clearer-design-rii9k6` | Maeda — *The Laws of Simplicity* | Ten laws; the cheapest one is "reduce," the most expensive one is "understand." |
| `ideo-design-process-observe-brainstorm-prototype-iterate-1qvodax` | Kelley — *The Art of Innovation* | Observe, brainstorm, prototype, iterate — the IDEO loop in the order it actually works. |
...
| `freakonomics-incentives-and-causal-inference-1hisp` | Levitt & Dubner — *Freakonomics* | Incentives explain everything that morality can't. |
| `success-making-ideas-stick-1to2c2n` | Heath & Heath — *Made to Stick* | SUCCESs: Simple, Unexpected, Concrete, Credible, Emotional, Stories. |
| `value-investing-graham-s-core-discipline-j4ppt3` | Graham — *The Intelligent Investor* | Price is what you pay, value is what you get, margin of safety is what keeps you solvent. |
| `rich-dad-poor-dad-the-financial-literacy-mindset-1krapzz` | Kiyosaki — *Rich Dad Poor Dad* | Assets put money in your pocket; liabilities take it out. The mindset is the leverage. |
...
| `100-days-of-writing-reasoning-argument-logic-na6pzg` | (Dr Non — *100 Days of Writing: Reasoning*) | Intellectual honesty, dismantling stigma, finding clarity through constraint. |
| `design-by-writing-100-day-reflection-engine-ziojx2` | (Dr Non — *Design by Writing*) | Daily writing as a design thinking toolkit; concrete moves for user stories and iteration. |
| `self-managed-project-mastery-100-days-of-writing-1e5bhwu` | (Dr Non — *Self-Managed Project Mastery*) | Daily writing as a disciplined project-management system. |
| `repetition-mantra-building-skill-through-simple-repeats-4as3as` | (Dr Non — *Repetition Mantra*) | A short, repeated phrase as a mental anchor for fluency. |
...
| Local slug | Book | Essence |
|---|---|---|
| `business-model-generation-mastering-the-canvas-k519i1` | Osterwalder — *Business Model Generation* | Nine building blocks; the canvas is the conversation, not the answer. |
| `value-proposition-design-1mtu6jn` | Osterwalder — *Value Proposition Design* | Jobs, pains, gains. Build what fits, not what sounds impressive. |
| `atomic-habits-blueprint-bh9jje` | Clear — *Atomic Habits* | Tiny behaviors compound; redesign the environment, not the will. |

---

## Counts (so the badges stay honest)
...
It is not a "best books for product managers" list. It is not a curated canon. It is the set of books Dr Non actually reads, distilled by the book-to-skill pipeline at `nonscrape.nonarkara.org`, and pulled into this repo so the practice has a stable offline copy and the agent can find them without network access.

If you find a book missing, the workflow is:

1. Open `https://nonscrape.nonarkara.org`, switch to **Non-Skills** mode, paste the book's URL.
2. The pipeline produces the live skill.
3. Mirror the essence here in the same format.

The local SKILL.md and the live skillhub are kept in sync by hand, not by automation. That hand-check is what catches drift before it ships.
