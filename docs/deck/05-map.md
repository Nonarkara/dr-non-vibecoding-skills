...
> **A decision map, not a toolbox.** 71 skills, grouped by the decision they change. Eight categories. One skill per category is the daily ceiling; everything else is a lookup.
