...
The 71 skills are the lookups. The 13 playbooks are the receipts for the lookups. The 7 references are the stable implementation details. The 12 templates are the drop-in files. The whole collection is the **decision ledger** that compounds.
