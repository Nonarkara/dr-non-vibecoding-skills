...
The 168 skills are the lookups. The 16 playbooks are the receipts for the lookups. The 13 references are the stable implementation details. The 17 templates are the drop-in files. The whole collection is the **decision ledger** that compounds.
