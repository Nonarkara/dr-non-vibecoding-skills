...
**The system's secret is not the model.** It is the four shapes — **88 skills**, **15 playbooks**, **7 references**, **13 templates** — wired into one routing loop, with the count being a real number and not a marketing claim.
