...
**The system's secret is not the model.** It is the four shapes — **167 skills**, **16 playbooks**, **13 references**, **17 templates** — wired into one routing loop, with the count being a real number and not a marketing claim.
