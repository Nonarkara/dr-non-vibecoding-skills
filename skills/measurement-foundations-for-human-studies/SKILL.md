---
name: measurement-foundations-for-human-studies
description: >-
  Define constructs, indicators, validity, and uncertainty before collecting numbers. Use when human qualities risk being reduced to misleading metrics.
license: MIT
---
