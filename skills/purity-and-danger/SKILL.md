---
name: purity-and-danger
description: >-
  Map taboo, pollution, and classification back to the boundary being defended. Use when a community rule seems irrational without its social order.
license: MIT
---
