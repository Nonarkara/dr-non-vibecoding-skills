---
name: choice-architecture-nudging-decisions-without-coercion
description: >-
  Design defaults, options, and friction without coercion. Use when a product presents consequential choices or a default may steer behavior.
license: MIT
---
