...
# would install 88 skills → /Users/<you>/.claude/skills  (claude)
# would install 88 skills → /Users/<you>/.agents/skills  (codex)
# would install 88 skills → /Users/<you>/.gemini/antigravity/skills  (antigravity)
# dry-run: no files changed (expected 88 skills)
```
...
```
□ ./setup.sh --become-builder --dry-run shows 88 skills to the detected hosts
