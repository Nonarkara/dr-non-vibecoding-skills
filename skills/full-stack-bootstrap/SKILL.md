...
# would install 167 skills → /Users/<you>/.claude/skills  (claude)
# would install 167 skills → /Users/<you>/.agents/skills  (codex)
# would install 167 skills → /Users/<you>/.gemini/antigravity/skills  (antigravity)
# dry-run: no files changed (expected 167 skills)
```
...
```
□ ./setup.sh --become-builder --dry-run shows 167 skills to the detected hosts
