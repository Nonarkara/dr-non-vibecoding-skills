...
4 artifact types → skills in `skills/` → one agent practice. (This slide was drawn when the tree had 25 skills; the live count is the README badges: **167 skills** · **16 playbooks** · **13 references** · **17 templates**. The one-liner is `./setup.sh --become-builder`.)
