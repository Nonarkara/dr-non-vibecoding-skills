...
4 artifact types → skills in `skills/` → one agent practice. (This slide was drawn when the tree had 25 skills; the live count is the README badges: **69 skills** · **13 playbooks** · **7 references** · **12 templates**. The one-liner is `./setup.sh --become-builder`.)
